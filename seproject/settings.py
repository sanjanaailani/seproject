...
SECRET_KEY = 'django-insecure-+jzk+io(whj)2h%xcn24&bwq-d7$9zrlq_dp$th5)da7h%bf*@'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Cluster78736',
        'CLIENT': {
            'host': 'mongodb+srv://Cluster78736:U25nU2B8Unpr@cluster78736.5ou8z.mongodb.net/Cluster78736?retryWrites=true&w=majority',
            'tls': True,
